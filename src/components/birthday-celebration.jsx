    ...
    <div className="flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <div className="text-center text-white">
              <p className="text-lg font-medium mb-4">Pencet buat {isCardOpen ? "tutup" : "buka"} kartunya dik</p>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Just a little reminder, you always jadi my favorite person. Everything feels nicer when it’s with you.
                </p>
      ...
      >
        <div className="text-center">
          ...
          Camat nambah umur adik🤍 Semoga everything you’ve been hoping for finds its way to you. You deserve so much happiness, honestly.
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Stay with me terus yaa...</p>
          </div>
        </div>
      </motion.div>
    </div>
